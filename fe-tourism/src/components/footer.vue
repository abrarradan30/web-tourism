    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><RouterLink to="/" class="text-gray-400 hover:text-white">Home</RouterLink></li>
            <li>
            ...
            <li>
              <RouterLink to="/halaman2" class="text-gray-400 hover:text-white"
                >Halaman2</RouterLink
              >
            </li>
          </ul>
      ...
      <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
        <p>© 2023 Ministry of Tourism, Republic of Indonesia. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
